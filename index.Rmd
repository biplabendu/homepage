...
```{r echo=FALSE, out.width='100%', fig.align='center', fig.cap="A cadaver of the Florida carpenter ant (*Camponotus floridanus*) infected by the fungal parasite *Ophiocordyceps camponoti-floridani*. Photo courtesy: [Danny Goodding](https://www.dannygoodding.com/)"}
library(knitr)
