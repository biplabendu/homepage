...
#### Tutorial - Plotting publication-quality figures using R

This tutorial is intended to get you started with programming in R, using RStudio Cloud and a shared project (link provided below). The code in the R script will generate high-quality plots using an example dataset, and save them to your local hard disk for use.

Shared project link: https://rstudio.cloud/project/1049250

Note: This tutorial was created for students taking my Principles of Ecology lab.
