...
path_to_repo = "/Users/biplabendudas/Documents/04_postdoc/Deborah_Gordon/04_research/2022/01_field_season_2022/01_readings/2018_Pagliara_et_al"
...
auc.dat %>% 
  ...
  ggplot(aes(x=age_class, y=auc/dur_mins)) +
    ...
    geom_jitter(width = 0.1, size=2, alpha=0.8, aes(col=as.factor(colony_ID))) +
...
```{r plot_tot_foraging_v1, echo = FALSE, fig.align='center', fig.cap='I/O plots as a function of time', out.width="95%"}
  knitr::include_graphics(paste0(path_to_repo,
           "/../2022_Nova_et_al/04_results/",
           "total_foraging_v1.png"))
```
