...
filename <- "arizona_2022_master_list_Aug23_1440h.csv"
...
- **Colony 1456** was not part of our priority list of colonies; MNW observed 1456 once on 8/19/22 but they were not active.
...
tidy.dat %>% 
  ...
  write.csv(.,
            file = paste0(path_to_repo, "/04_results/",
                          "colonies_for_which_foraging_data_is_available.csv"),
            row.names = F)
